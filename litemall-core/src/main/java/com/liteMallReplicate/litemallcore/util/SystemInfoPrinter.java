...
public class SystemInfoPrinter {
    ...
    public static final String CREATE_PART_COPPER = "XOXOXO";

    private static int maxSize = 0;

    public static void printInfo(String title, Map<String, String> info) {
        setMaxSize(info);
    ...
    private static void setMaxSize(Map<String, String> info) {
        for (Map.Entry<String, String> entry : info.entrySet()) {
