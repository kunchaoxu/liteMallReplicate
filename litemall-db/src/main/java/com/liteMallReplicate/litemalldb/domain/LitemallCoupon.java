...
public class LitemallCoupon {
    ...
    public enum Deleted {
        NOT_DELETED(true, "undeleted"),
        IS_DELETED(false, "deleted");
    ...
    public enum Column {
        ...
        public String getEscapedColumnName() {
            if (this.isColumnNameDelimited) {
                return new StringBuilder().append(BEGINNING_DELIMITER).append(this.column).append(ENDING_DELIMITER).append(this.column)
